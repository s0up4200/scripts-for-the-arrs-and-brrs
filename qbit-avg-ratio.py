...
def parse_arguments():
    ...
    parser.add_argument('--host', type=str, default=QBITTORRENT_HOST, help=f'qBittorrent Web UI host (default: {QBITTORRENT_HOST})')
    parser.add_argument('--username', type=str, default=QBITTORRENT_USERNAME, help=f'qBittorrent Web UI username (default: {QBITTORRENT_USERNAME})')
    parser.add_argument('--password', type=str, default=QBITTORRENT_PASSWORD, help=f'qBittorrent Web UI password (default: {QBITTORRENT_PASSWORD})')
    ...
    parser.add_argument('--exclude-tags', type=str, nargs='+', default=[], help='Exclude specified tags')
    parser.add_argument('--exclude-categories', type=str, nargs='+', default=[], help='Exclude specified categories')
...
def main():
    ...
    sorted_categories = filter_excluded_items(sorted_categories, args.exclude_categories)
